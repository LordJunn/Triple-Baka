...
const changeDimension = (event) => {
  ...
  // Ensure the new dimension is 2 - 15
  if (newDimension < 2) {
    event.target.value = 2; // Reset to the minimum value
  } else if (newDimension > 12) {
    event.target.value = 12; // Reset to the maximum value
  }
  else {
